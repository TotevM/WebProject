        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Sets = table.Column<int>(type: "int", nullable: false, defaultValue: 4),
                    Repetitions = table.Column<int>(type: "int", nullable: false, defaultValue: 10)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("2995c236-5b5d-42f9-89b5-15576256ee66"), 350, 30, new DateTime(2024, 12, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), 15, 0, "https://thebeanbites.com/wp-content/uploads/2020/03/Instant-Pot-Stuffed-Peppers-10-720x540.jpg", "Bell peppers, ground turkey, quinoa, cheese", false, "Stuffed Bell Peppers", "Preheat the oven to 375°F (190°C). Prepare the bell peppers by cutting off the tops and removing the seeds and membranes. In a mixing bowl, combine cooked quinoa, browned ground turkey, and shredded cheese. Season the mixture with salt and pepper to taste. Stuff each bell pepper with the quinoa and turkey mixture, packing it tightly. Arrange the stuffed peppers upright in a baking dish, cover the dish with foil, and bake for 30 minutes. Remove the foil and bake for an additional 10 minutes until the peppers are tender and the cheese is melted and golden. Serve hot.", 25, null },
